 ...
 setCount(count-1);
  ...
  return (
   ...
   items-center  bg-[#344151] flex-col gap-10">
    ...
    <div  className="bg-white flex flex-row justify-center gap-12
    py-3 rounded-sm text-[25px] text-[#344151]">
    ...
    className=" bg-[#0398d4] text-white px-5 py-0
    rounded-sm text-lg">Reset</button>
   </div>
  );
}
